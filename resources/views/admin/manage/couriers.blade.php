    ...
    <div class="container-fluid">
        <div class="sb-page-header-content py-5">
            <h1 class="sb-page-header-title">
                ...
                <span>Manage Couriers - {{ ucwords($manage_label) }}</span>
            </h1>
        </div>
    </div>
</div>
<div class="container-fluid mt-n10">
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form role="form" action="/manage/couriers/{{ $manage_label }}" method="POST">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input class="form-control" type="text" value="{{ isset($edit['phone']) ? $edit['phone'] : '' }}" name="phone" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input class="form-control" type="text" value="{{ isset($edit['contact']) ? $edit['contact'] : '' }}" name="contact" required>
                    </div>
                </div>
                <div class="form-group row">

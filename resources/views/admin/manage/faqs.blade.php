    ...
    <div class="container-fluid">
        <div class="sb-page-header-content py-5">
            <h1 class="sb-page-header-title">
                ...
                <span>Manage FAQs - {{ ucwords($manage_label) }}</span>
            </h1>
        </div>
    </div>
</div>
<div class="container-fluid mt-n10">
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form role="form" action="/manage/faqs/{{ $manage_label }}" method="POST">
                @csrf
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <input class="form-control" type="text" value="{{ isset($edit['question']) ? $edit['question'] : '' }}" name="question" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label form-control-label">Answer</label>
                    <div class="col-lg-9">
                        <textarea class="form-control" name="answer" required>{{ isset($edit['answer']) ? $edit['answer'] : '' }}</textarea>
                    </div>
                </div>
                <div class="form-group row">

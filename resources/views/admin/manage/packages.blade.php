    ...
    <div class="container-fluid">
        <div class="sb-page-header-content py-5">
            <h1 class="sb-page-header-title">
                ...
                <span>Manage Packages - {{ ucwords($manage_label) }}</span>
            </h1>
        </div>
    </div>
</div>
<div class="container-fluid mt-n10">
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form role="form" action="/manage/packages/{{ $manage_label }}" method="POST">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input class="form-control" type="text" value="{{ isset($edit['price']) ? $edit['price'] : '' }}" name="price" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label form-control-label">Details</label>
                    <div class="col-lg-9">
                        <textarea class="form-control" name="details" required>{{ isset($edit['details']) ? $edit['details'] : '' }}</textarea>
                    </div>
                </div>
                <div class="form-group row">

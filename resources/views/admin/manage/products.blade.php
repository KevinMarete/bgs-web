    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form role="form" action="/manage/products/{{ $manage_label }}" method="POST">
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label form-control-label">Strength</label>
                    <div class="col-lg-9">
                        <input class="form-control" type="text" value="{{ isset($edit['strength']) ? $edit['strength'] : '' }}" name="strength" required>
                    </div>
                </div>
                <div class="form-group row">

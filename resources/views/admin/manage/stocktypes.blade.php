    ...
    <div class="container-fluid">
        <div class="sb-page-header-content py-5">
            <h1 class="sb-page-header-title">
                ...
                <span>Manage StockTypes - {{ ucwords($manage_label) }}</span>
            </h1>
        </div>
    </div>
</div>
<div class="container-fluid mt-n10">
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form role="form" action="/manage/stocktypes/{{ $manage_label }}" method="POST">
                @csrf
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label form-control-label">Effect</label>
                    <div class="col-lg-9">
                        <select class="form-control" size="0" name="effect" required>
                            <option value="">Select Effect</option>
                            @if ((isset($edit['effect']) ? $edit['effect'] : '') == '1')
                                <option value="1" selected>Add</option>
                                <option value="0">Remove</option>
                            @elseif ((isset($edit['effect']) ? $edit['effect'] : '') == '0')

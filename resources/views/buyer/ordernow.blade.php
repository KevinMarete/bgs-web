                        ...
                        @if ($product['is_published'])
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title"><a href="product.html" title="View Product">{{ $product['product']['molecular_name'] }}</a></h4>
                                        <p class="card-text">
                                            <strong>{{ $product['product']['brand_name'] }}</strong> <br/>
                                            <strong>Packsize:</strong> {{ $product['product']['pack_size'] }} <br/>
                                            <strong>Strength:</strong> {{ $product['product']['strength'] }}
                                        </p>
                                        <div class="row">
                                            <div class="col">
                                                <p class="btn btn-danger btn-block">KES {{$product['unit_price'] }}</p>
                                            </div>
                                            <div class="col">

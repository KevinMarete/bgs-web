    ...
    <div class="card-body">
      <div class="col">
        <div class="row" data-jplist-group="products">
          ...
          <div class="col-sm-12 col-md-4 col-lg-3 mb-4" data-jplist-item>
            <div class="card">
              <div class="row">
                <div class="col">
              ...
              <div class="row">
                <div class="col">
                  <form role="form" action="/add-cart" method="POST">
                    ...
                    <input type="hidden" class="form-control" name="product_description" value="{{ $product['product']['brand_name'] }}">
